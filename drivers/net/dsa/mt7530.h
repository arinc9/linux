...
#define  MDIO_REG_DEV_ADDR_MASK		GENMASK(29, 25)
#define  MDIO_REG_DEV_ADDR(x)		FIELD_PREP(MDIO_REG_DEV_ADDR_MASK, x)
#define  MDIO_PHY_ADDR_MASK		GENMASK(24, 20)
#define  MDIO_PHY_ADDR(x)		FIELD_PREP(MDIO_PHY_ADDR_MASK, x)
#define  MDIO_CMD_MASK			GENMASK(19, 18)
#define  MDIO_CMD(x)			FIELD_PREP(MDIO_CMD_MASK, x)
#define  MDIO_ST_MASK			GENMASK(17, 16)
#define  MDIO_ST(x)			FIELD_PREP(MDIO_ST_MASK, x)
#define  MDIO_RW_DATA_MASK		GENMASK(15, 0)

enum mt753x_phy_iac_cmd {
	MDIO_ADDR = 0,
	MDIO_WRITE = 1,
	MDIO_READ = 2,
	MDIO_READ_CL45 = 3,
...
#define  MDIO_CL22_READ			(MDIO_ST(MDIO_ST_CL22) | \
					 MDIO_CMD(MDIO_READ))
#define  MDIO_CL22_WRITE		(MDIO_ST(MDIO_ST_CL22) | \
					 MDIO_CMD(MDIO_WRITE))
#define  MDIO_CL45_ADDR			(MDIO_ST(MDIO_ST_CL45) | \
					 MDIO_CMD(MDIO_ADDR))
#define  MDIO_CL45_READ			(MDIO_ST(MDIO_ST_CL45) | \
					 MDIO_CMD(MDIO_READ))
#define  MDIO_CL45_WRITE		(MDIO_ST(MDIO_ST_CL45) | \
					 MDIO_CMD(MDIO_WRITE))
